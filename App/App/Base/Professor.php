...
abstract class Professor implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\App\\Map\\ProfessorTableMap';
    ...
    /**
     * Initializes internal state of App\App\Base\Professor object.
     */
     ...
     * @return $this|\App\App\Professor The current object (for fluent API support)
     */
    public function setCodprofessor($v)
    {
        ...
        if ($this->codprofessor !== $v) {
            $this->codprofessor = $v;
            $this->modifiedColumns[ProfessorTableMap::COL_CODPROFESSOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProfessorTableMap::translateFieldName('Codprofessor', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ProfessorTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\App\\Professor'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ProfessorTableMap::COL_CODPROFESSOR] = true;
        if (null !== $this->codprofessor) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ProfessorTableMap::COL_CODPROFESSOR . ')');
        }
        if (null === $this->codprofessor) {
            try {
                $dataFetcher = $con->query("SELECT nextval('professor_codprofessor_seq')");
                $this->codprofessor = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(ProfessorTableMap::COL_CODPROFESSOR)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCodprofessor($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\App\Professor The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProfessorTableMap::COL_CODPROFESSOR)) {
            $criteria->add(ProfessorTableMap::COL_CODPROFESSOR, $this->codprofessor);
        }
        if ($this->isColumnModified(ProfessorTableMap::COL_NOME)) {
    ...
    {
        $validPk = null !== $this->getCodprofessor();
    ...
    /**
     * Generic method to set the primary key (codprofessor column).
     *
    ...
    {
        return null === $this->getCodprofessor();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\App\Professor (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCodprofessor(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\App\Professor Clone of current object.
     * @throws PropelException
     */
     ...
     * @return ObjectCollection|ChildTrabalho[] List of ChildTrabalho objects
     */
    public function getTrabalhosJoinAluno(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTrabalhoQuery::create(null, $criteria);
