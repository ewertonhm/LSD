...
abstract class Aluno implements ActiveRecordInterface
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AlunoTableMap::COL_ID] = true;
        }
    ...
    public function setEndereco($v)
    {
        ...
        if ($this->endereco !== $v) {
            $this->endereco = $v;
            $this->modifiedColumns[AlunoTableMap::COL_ENDERECO] = true;
        }
    ...
    public function setTelefone($v)
    {
        ...
        if ($this->telefone !== $v) {
            $this->telefone = $v;
            $this->modifiedColumns[AlunoTableMap::COL_TELEFONE] = true;
        }
    ...
    public function setUsuarioId($v)
    {
        ...
        if ($this->usuario_id !== $v) {
            $this->usuario_id = $v;
            $this->modifiedColumns[AlunoTableMap::COL_USUARIO_ID] = true;
        }
    ...
    public function setCursoId($v)
    {
        ...
        if ($this->curso_id !== $v) {
            $this->curso_id = $v;
            $this->modifiedColumns[AlunoTableMap::COL_CURSO_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AlunoTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AlunoTableMap::translateFieldName('Endereco', TableMap::TYPE_PHPNAME, $indexType)];
            $this->endereco = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AlunoTableMap::translateFieldName('Telefone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->telefone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AlunoTableMap::translateFieldName('UsuarioId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('aluno_id_seq')");
        ...
        if ($this->isColumnModified(AlunoTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AlunoTableMap::COL_NOME)) {
            $modifiedColumns[':p' . $index++]  = 'nome';
        }
        if ($this->isColumnModified(AlunoTableMap::COL_ENDERECO)) {
            $modifiedColumns[':p' . $index++]  = 'endereco';
        }
        if ($this->isColumnModified(AlunoTableMap::COL_TELEFONE)) {
            $modifiedColumns[':p' . $index++]  = 'telefone';
        }
        if ($this->isColumnModified(AlunoTableMap::COL_USUARIO_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlunoTableMap::COL_ID)) {
            $criteria->add(AlunoTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AlunoTableMap::COL_NOME)) {
            $criteria->add(AlunoTableMap::COL_NOME, $this->nome);
        }
        if ($this->isColumnModified(AlunoTableMap::COL_ENDERECO)) {
            $criteria->add(AlunoTableMap::COL_ENDERECO, $this->endereco);
        }
        if ($this->isColumnModified(AlunoTableMap::COL_TELEFONE)) {
            $criteria->add(AlunoTableMap::COL_TELEFONE, $this->telefone);
        }
        if ($this->isColumnModified(AlunoTableMap::COL_USUARIO_ID)) {
            $criteria->add(AlunoTableMap::COL_USUARIO_ID, $this->usuario_id);
        }
        if ($this->isColumnModified(AlunoTableMap::COL_CURSO_ID)) {
    ...
    {
        if (null !== $this->aCurso) {
            $this->aCurso->removeAluno($this);
        }
        if (null !== $this->aUsuario) {
            $this->aUsuario->removeAluno($this);
        }
        $this->id = null;
        $this->nome = null;
        $this->endereco = null;
