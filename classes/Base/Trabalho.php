...
abstract class Trabalho implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TrabalhoTableMap';
    ...
    /**
     * The value for the caminho_arquivo field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Base\Trabalho object.
     */
    ...
    /**
     * Get the [caminho_arquivo] column value.
     *
     * @return string
     */
     ...
     * @return $this|\Trabalho The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TrabalhoTableMap::COL_ID] = true;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== null || $dt !== null) {
            if ($this->data === null || $dt === null || $dt->format("Y-m-d") !== $this->data->format("Y-m-d")) {
                ...
                $this->modifiedColumns[TrabalhoTableMap::COL_DATA] = true;
            }
    ...
    /**
     * Set the value of [caminho_arquivo] column.
     *
     * @param string $v new value
     * @return $this|\Trabalho The current object (for fluent API support)
     */
    public function setCaminhoArquivo($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->caminho_arquivo !== $v) {
            $this->caminho_arquivo = $v;
            $this->modifiedColumns[TrabalhoTableMap::COL_CAMINHO_ARQUIVO] = true;
        }
    ...
    public function setComentario($v)
    {
        ...
        if ($this->comentario !== $v) {
            $this->comentario = $v;
            $this->modifiedColumns[TrabalhoTableMap::COL_COMENTARIO] = true;
        }
    ...
    public function setUsuarioId($v)
    {
        ...
        if ($this->usuario_id !== $v) {
            $this->usuario_id = $v;
            $this->modifiedColumns[TrabalhoTableMap::COL_USUARIO_ID] = true;
        }
    ...
    public function setProfessorId($v)
    {
        ...
        if ($this->professor_id !== $v) {
            $this->professor_id = $v;
            $this->modifiedColumns[TrabalhoTableMap::COL_PROFESSOR_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TrabalhoTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TrabalhoTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            $this->data = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TrabalhoTableMap::translateFieldName('CaminhoArquivo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->caminho_arquivo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TrabalhoTableMap::translateFieldName('Comentario', TableMap::TYPE_PHPNAME, $indexType)];
            $this->comentario = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TrabalhoTableMap::translateFieldName('UsuarioId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usuario_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TrabalhoTableMap::translateFieldName('ProfessorId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = TrabalhoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Trabalho'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('trabalho_id_seq')");
        ...
        if ($this->isColumnModified(TrabalhoTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TrabalhoTableMap::COL_DATA)) {
            $modifiedColumns[':p' . $index++]  = 'data';
        }
        if ($this->isColumnModified(TrabalhoTableMap::COL_CAMINHO_ARQUIVO)) {
            $modifiedColumns[':p' . $index++]  = 'caminho_arquivo';
        }
        if ($this->isColumnModified(TrabalhoTableMap::COL_COMENTARIO)) {
            $modifiedColumns[':p' . $index++]  = 'comentario';
        }
        if ($this->isColumnModified(TrabalhoTableMap::COL_USUARIO_ID)) {
            $modifiedColumns[':p' . $index++]  = 'usuario_id';
        }
        if ($this->isColumnModified(TrabalhoTableMap::COL_PROFESSOR_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'caminho_arquivo':
                        $stmt->bindValue($identifier, $this->caminho_arquivo, PDO::PARAM_STR);
                        break;
                    case 'comentario':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getData(),
            $keys[2] => $this->getCaminhoArquivo(),
            $keys[3] => $this->getComentario(),
            $keys[4] => $this->getUsuarioId(),
            $keys[5] => $this->getProfessorId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setCaminhoArquivo($arr[$keys[2]]);
        }
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setProfessorId($arr[$keys[5]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TrabalhoTableMap::COL_ID)) {
            $criteria->add(TrabalhoTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TrabalhoTableMap::COL_DATA)) {
            $criteria->add(TrabalhoTableMap::COL_DATA, $this->data);
        }
        if ($this->isColumnModified(TrabalhoTableMap::COL_CAMINHO_ARQUIVO)) {
            $criteria->add(TrabalhoTableMap::COL_CAMINHO_ARQUIVO, $this->caminho_arquivo);
        }
        if ($this->isColumnModified(TrabalhoTableMap::COL_COMENTARIO)) {
            $criteria->add(TrabalhoTableMap::COL_COMENTARIO, $this->comentario);
        }
        if ($this->isColumnModified(TrabalhoTableMap::COL_USUARIO_ID)) {
            $criteria->add(TrabalhoTableMap::COL_USUARIO_ID, $this->usuario_id);
        }
        if ($this->isColumnModified(TrabalhoTableMap::COL_PROFESSOR_ID)) {
            $criteria->add(TrabalhoTableMap::COL_PROFESSOR_ID, $this->professor_id);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCaminhoArquivo($this->getCaminhoArquivo());
    ...
    {
        if ($this->aProfessor === null && ($this->professor_id != 0)) {
    ...
    public function getUsuario(ConnectionInterface $con = null)
    {
        if ($this->aUsuario === null && ($this->usuario_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuario->addTrabalhos($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aUsuario) {
            $this->aUsuario->removeTrabalho($this);
        }
        $this->id = null;
        $this->data = null;
